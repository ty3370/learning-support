...
COMMON_PROMPT = (
    ...
    "학생이 문제를 내달라고 하면, 교과서에 나오는 내용에 철저하게 기반해서 출제해 주세요. 단순 개념 문제, 개념을 실제 상황에 적용하는 문제, 그림이나 표를 해석하는 문제, 선택형 문제, 서술형 문제 등 다양한 유형의 문제를 출제하세요. 한 번에 여러 개의 문제를 달라는 요청이 없다면, 하나의 대화에서는 한 문제만 내세요.\n"
